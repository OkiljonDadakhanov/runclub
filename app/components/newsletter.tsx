            ...
            <div className="max-w-7xl mx-auto">
                <div className="bg-gradient-to-r from-[#537BF8] to-indigo-600 rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-1/2 bg-white p-8 lg:p-12">
                        ...
                        <div className="">
                            <form action="" className="flex flex-col sm:flex-row gap-4 mt-4 mb-2">
                                ...
                                <ButtonMenu
                                    buttonColor="white"
                                    colorScheme="#537BF8"
                                    className="bg-[#537BF8] text-white font-bold py-6 px-7 rounded-lg transition-colors duration-300 hover:bg-indigo-600"
                                >
                                    Subscribe
                                </ButtonMenu>
                        ...
                        <span className="text-gray-400 text-sm italic">Your email is safe with us, we don not spam.</span>
